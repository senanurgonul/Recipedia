...
class _RCTodayStoryScreenState extends State<RCTodayStoryScreen> {
  ...
  void initState() {
    ...
    collectionList.add(RCCollectionModel(name: 'Cookbook', image: 'images/recipe/coffee.jpg', numberOfPosts: '15', selected: false));
    collectionList.add(RCCollectionModel(name: 'Ice Cream', image: 'images/recipe/milkShakes.jpg', numberOfPosts: '3', selected: false));
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned(top: context.statusBarHeight + 24, left: 16, child: RCBackComponent(color: Colors.white, borderColor: Colors.white)),
          Positioned(
            top: 150,
            left: 16,
            child: Column(

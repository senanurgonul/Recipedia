        ...
        children: [
              ...
              children: [
                ...
                ClipPath(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(widget.element.foodImg.validate(), fit: BoxFit.cover).cornerRadiusWithClipRRect(30),
                  ),
                ),
              ],
            ),
          ...
          widget.isProfile ? Offstage() : Row(
            ...
            children: [
              ...
              Text(widget.element.subTitle, style: primaryTextStyle(color: rcSecondaryTextColor),)
            ],
          ) ,
